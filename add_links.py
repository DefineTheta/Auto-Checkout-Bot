...
class addLinks(object):
    def initUI(self, dialog):
    	self.win = dialog
    	dialog.setWindowTitle("Add Scrape Links ~ Shopify Destroyer")
        ...
        self.linkTextEdit = QtGui.QTextEdit(dialog)
        self.linkTextEdit.setGeometry(QtCore.QRect(10, 35, 571, 271))        
        self.linkTextEdit.setFont(self.font)
        ...
        self.infoLabel.setText("Add all the sitemap links in the text area below:")
